    ...
    tabItems(
      ...
      tabItem(tabName = "Overview", 
              fluidPage(
                    ...
                    sidebarPanel(width=3,
                       fluidRow(
                         p("This website analyzes and visualizes the COVID-19 case data from the NYT. 
                           It may take about 10 secs to complete graphics rendering on your browser."),
                         p(em(" For more information and disclaimer, please see 'Additional Info' tab.")),
                         # h6(em(paste0("Last Data Update: ", last_update)))
                ...
                # box(title=em(paste0("Data Plots for States with ", case_min, "+ Cases")), 
                box(title=em(paste0("Data Plots for States with Highest Case Count")), 
                    status = "primary", width = 12, solidHeader = F, collapsible = T,
                    
                         tabBox(width = 12,
                                tabPanel("Latest", plotlyOutput("state_case_growth", height = "480px")),
                                tabPanel("Cumulative Cases", plotlyOutput("state_case", height = "480px")),
